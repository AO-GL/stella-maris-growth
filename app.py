...
def make_square_image(product_focus, caption, concept, uploaded_image=None):

    width, height = 2000, 2000

    bg = Image.new("RGB", (width, height), (248, 246, 240))
    ...
    draw.text(
        (150, 1840),
        "Luxury Collection · Social Media Ready",
        fill=gold,
        font=tiny_font
    )
...
st.caption(
    "Erstellt direkt sichtbare JPG-Marketingbilder, "
    "Captions und Reel-Konzepte."
)

st.warning(
    "Keine Auto-Follows, keine Massen-DMs, kein Spam. "
...
with left:
    ...
    if is_safe_time(posting_time):
        ...
        st.error(
            "Besser zu üblichen Zeiten posten: "
            "08–10, 12–14 oder 17:30–20:30."
        )

    generate = st.button(
        "JPG-Marketingbilder generieren",
        type="primary"
    )
...
with right:
    ...
    st.info(
        "In der App werden kleine Thumbnails angezeigt. "
        "Der Download ist JPG 2000 × 2000 px mit 300 DPI."
    )
